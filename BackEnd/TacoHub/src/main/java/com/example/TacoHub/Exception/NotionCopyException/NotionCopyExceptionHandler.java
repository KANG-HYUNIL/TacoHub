...
public class NotionCopyExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleWorkspaceOperation(WorkSpaceOperationException ex) {
    ...
    public ResponseEntity<ErrorResponseDTO> handlePageNotFound(PageNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponseDTO> handlePageOperation(PageOperationException ex) {
    ...
    public ResponseEntity<ErrorResponseDTO> handleBlockNotFound(BlockNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponseDTO> handleBlockOperation(BlockOperationException ex) {
    ...
    public ResponseEntity<ErrorResponseDTO> handleWorkSpaceUserNotFound(WorkSpaceUserNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponseDTO> handleWorkSpaceUserOperation(WorkSpaceUserOperationException ex) {
